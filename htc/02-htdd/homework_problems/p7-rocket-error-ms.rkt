...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname p7-rocket-error-ms) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
