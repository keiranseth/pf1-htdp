...
(define VARIABLE-OPERATIONAL-COST 1.50)
...
; After removing the fixed operational cost and changing the variable operational cost accordingly,
; a 4$ ticket price produces the most profit to the movie theater.