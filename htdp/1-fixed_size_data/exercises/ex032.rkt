...
;  blood component ratios in general
;  nearby traffic
;  sudden emergency situations (earthquakes, heavy rainfall, floods, etc...)
;  local weather and suggested outfits for the day
;  neurological activity such as:
;    neurotransmitter imbalances like serotonin, dopamine, and norepinephrine
;    changes in brain activity in the prefrontal cortex, amygdala, etc...