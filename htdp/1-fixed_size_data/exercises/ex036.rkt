...
;; Image -> Natural
;; Given an image, return its area (* width height).
(check-expect (image-area (square 11 "solid" "Blue")) 121)
(check-expect (image-area (rectangle 10 40 "solid" "Sea Green")) 400)
