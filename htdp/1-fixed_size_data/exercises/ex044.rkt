...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex044) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define TREE
  (above (circle WHEEL-RADIUS "solid" "green")
         (rectangle 2 (* WHEEL-RADIUS 3) "solid" "brown")))
